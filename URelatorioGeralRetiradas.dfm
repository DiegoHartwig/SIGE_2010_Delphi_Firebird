object frmRelatorioGeralRetiradas: TfrmRelatorioGeralRetiradas
  Left = 0
  Top = 0
  Caption = 'frmRelatorioGeralRetiradas'
  ClientHeight = 490
  ClientWidth = 795
  Color = clBtnFace
  ...
  object QuickRep1: TQuickRep
    ...
    DataSet = frmConRetiradas.qConsultaRetiradas
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = 'Arial'
    ...
    object QRBand1: TQRBand
      ...
      object QRLabel1: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Relat'#243'rio Geral das Retiradas'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -19
    ...
    object QRBand4: TQRBand
      ...
      object QRExpr1: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(qConsultaRetiradas.QUANTIDADE)'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 12
      end
      ...
      object QRLabel19: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Material mais Retirado:'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -16
      ...
      object QRExpr2: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'MAX(qConRetiradas.QUANTIDADE)'
        ExportAs = exptText
        WrapStyle = BreakOnSpaces
        FontSize = 12
      end
